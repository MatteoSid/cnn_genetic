...
TensorBoard_path = "/Users/matteo/Documents/GitHub/Cnn_Genetic/cnn_genetic/TensorBoard/logs"
...
def evluationmethod(l_rate, dropout, steps):
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter(TensorBoard_path + "lr_%.0E,%s,%s" % (l_rate, dropout, steps), sess.graph)
...
for dropout_rate in np.arange(0.1, 1, 0.10):


    for learning_rate in (np.arange(0.1, 0.01, -0.05)):
